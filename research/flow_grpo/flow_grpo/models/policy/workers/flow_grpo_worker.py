...
if TYPE_CHECKING:
    ...
    from flow_grpo.models.interfaces import DiffusionPolicyConfig
...
class FlowGRPOPolicyWorker:  # pragma: no cover
    ...
    def _build_adapter(self) -> None:
        from flow_grpo.models.pipeline import QwenImagePipelineAdapter
    ...
    def train_step(self, data, loss_cfg):
        ...
        from flow_grpo.algorithms.loss.flow_grpo import FlowGRPOLossFn
