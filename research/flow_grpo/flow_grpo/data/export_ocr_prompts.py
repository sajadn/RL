...
Usage:
  uv run python -m flow_grpo.data.export_ocr_prompts --out-dir data/ocr
  # or use a local flow_grpo checkout:
  uv run python -m flow_grpo.data.export_ocr_prompts --source-dir /path/to/flow_grpo/dataset/ocr --out-dir ...
"""
