...
def test_build_peft_config_maps_schema_fields():
    from flow_grpo.models.policy.workers.flow_grpo_worker import build_peft_config
...
def test_lora_scale_zero_matches_base_forward_bitwise():
    from flow_grpo.models.policy.workers.flow_grpo_worker import lora_scale_zero
...
def test_inlined_calculate_shift_matches_diffusers():
    ...
    from flow_grpo.models.policy.workers.flow_grpo_worker import calculate_shift
...
def test_lora_schema_defaults_are_full_path_patterns():
    from flow_grpo.models.interfaces import DiffusionLoraCfg
...
def test_exemplar_yaml_targets_are_full_path_patterns():
    ...
    with open("configs/recipes/flow_grpo_qwen_image_ocr.yaml") as f:
