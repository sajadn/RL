...
STEP_DIR=/lustre/fsw/portfolios/coreai/users/snorouzi/runs/diffusion_rl/ministral3_ar/checkpoints/step_900 \
OUT=/lustre/fsw/portfolios/coreai/users/snorouzi/checkpoints/ministral_3_step_900_hf \
